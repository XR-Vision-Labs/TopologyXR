...
namespace Oculus.Interaction
{
        ...
        IRigidbodyRef
    {
        ...
        public Transform _snapPoseTransform;
        ...
        {
            Debug.Log("inside selected set protected interactable");
        ...
        #region SetSelectUnselect

        public void SetSelectInteratable(SnapInteractable interactable)
        {

            SetComputeCandidateOverride(() => interactable, true);
            SetComputeShouldSelectOverride(() => true, true);
        }


        public void UnsetSelectInteractable()
        {
            base.UnselectInteractable();
        }
