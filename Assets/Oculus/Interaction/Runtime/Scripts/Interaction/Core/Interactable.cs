                                        ...
                                        where TInteractable : Interactable<TInteractor, TInteractable>
    {
        ...
        public void Disable()
        {
            ...
            if (_started)
            {
                ...
                //{
                //    if (selectingInteractor.CompareTag("exempt") || selectingInteractor.CompareTag("start") || selectingInteractor.CompareTag("end"))
                //        Debug.Log("SelectingInteractor exempted");
                //    else
