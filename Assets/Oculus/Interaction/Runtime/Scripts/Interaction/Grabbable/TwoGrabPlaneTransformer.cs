...
namespace Oculus.Interaction
{
    ...
    public class TwoGrabPlaneConstraints
    {
        ...
        public TwoGrabPlaneConstraints() { }

        public TwoGrabPlaneConstraints(FloatConstraint minScale, FloatConstraint maxScale, FloatConstraint minY, FloatConstraint maxY)
        {
            MinScale = minScale;
            MaxScale = maxScale;
            MinY = minY;
