...
public class TubeRenderer : MonoBehaviour
{
	...
	private bool isStreamCalled = false;
  ...
  //  private void Start()
  //  {
		//controller = transform.parent.GetComponent<WireController>();
  ...
  //  }
   ...
   //         if (controller != null)
   //         {
			//	SampleController.Instance.Log("Calling stream funciton");
			//	controller.StreamSegmentData();
   //         }
   //     }

		//WireController wireController = GetComponentInParent<WireController>();
  //      if (wireController != null)
  //      {
		//	SampleController.Instance.Log("Got the wire controller from parent now calling stream function");

		//	wireController.StreamSegmentData();
  //      }
